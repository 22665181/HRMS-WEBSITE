...
function Settings() {
  ...
  return (
    <div
      className={`${isDarkMode ? "dark-mode" : ""} ${modals && Object.values(modals).some(Boolean) ? "blurred-bg" : ""} min-vh-100`}
    >
      <Container fluid className="settings-container" style={{ overflowX: "hidden" }}>
        <Row className="justify-content-center">
          <Col lg={8}>
            <h3
              ...
              style={{ fontWeight: "bold", color: "#333", textAlign: "center", marginTop: "20px" }}
            >
              <u>Settings</u>
            </h3>
            <ListGroup variant="flush" className="settings-list mt-4">
              ...
              <ListGroup.Item
                action
                className="d-flex align-items-center gap-3 py-3 text-danger"
        ...
        {renderModal(
          ...
          <p>
            <div style={{ maxHeight: "60vh", overflowY: "auto" }}>
              <p>
                At <b>UPTOSKILLS</b>, your privacy is our top priority. Our HRMS-SOCIAL-CONNECT platform ensures that
                personal and professional information is handled with utmost care and in compliance with data protection
                standards.
              </p>
              <ul>
              ...
              <p>
                For more information, contact us at <a href="mailto:privacy@uptoskills.com">privacy@uptoskills.com</a>
              </p>
            </div>
          </p>,
        )}
        ...
        {renderModal(
          ...
          <div style={{ maxHeight: "60vh", overflowY: "auto" }}>
            ...
            <p>
              We do <b>not</b> use cookies for advertising or third-party tracking. You can disable cookies in your
              browser settings, but some features may be limited.
            </p>
          </div>,
        )}
        {renderModal(
          ...
          <div>
            ...
            <ul>
              <li>
                📧 <b>Email:</b> <a href="mailto:support@uptoskills.com">support@uptoskills.com</a>
              </li>
              <li>
        ...
        {renderModal(
          ...
          <>
            ...
            <Button variant="secondary" onClick={() => toggleModal("logout")}>
              Cancel
            </Button>
          </>,
        )}
